...
import { faCircle, faHeart, faMailBulk, faMapMarker, faMapPin, faFilePdf } from '@fortawesome/free-solid-svg-icons'
            ...
            <Row style={{ minHeight: '100vh' }} id="contact">
                <Row className="text-center text-white d-flex flex-row align-items-start py-3 my-5">
                    ...
                    <Col xs={6} sm={6} md={3} lg={3} xl={3} xxl={3}>
                        <a target="_blank" href="https://www.linkedin.com/in/septian-fauzi-09sf/" rel="noreferrer"><FontAwesomeIcon style={{ fontSize: '2.5rem' }} icon={faLinkedin} /></a>
                        <h5 className="mt-3 mb-0 font-bold">LinkedIn</h5>
                        <p>@septian-fauzi-09sf</p>
                        <a className='d-grid' target="_blank" href="https://www.linkedin.com/in/septian-fauzi-09sf/" rel="noreferrer">
                            <Button className="mx-1 text-white " variant="outline-secondary">Go to Linkedin</Button>
                        </a>
                    </Col>
                    <Col xs={6} sm={6} md={3} lg={3} xl={3} xxl={3}>
                        ...
                        <a className='d-grid' target="_blank" href="mailto:fauzy434@gmail.com" rel="noreferrer">
                            <Button className="mx-1 text-white " variant="outline-secondary">Send Email</Button>
                        </a>
                    </Col>
                    <Col xs={6} sm={6} md={3} lg={3} xl={3} xxl={3}>
                        ...
                        <p>@septianfauzi9</p>
                        <a className='d-grid' target="_blank" href="https://www.instagram.com/septianfauzi9" rel="noreferrer">
                            <Button className="mx-1 text-white " variant="outline-secondary">Go to Instagram</Button>
                        </a>
                    </Col>
                    <Col xs={6} sm={6} md={3} lg={3} xl={3} xxl={3}>
                        <FontAwesomeIcon className="text-white" style={{ fontSize: '2.5rem' }} icon={faFilePdf} />
                        <h5 className="mt-3 mb-0">CV</h5>
                        <p>Download My Latest CV</p>
                        <a className='d-grid' target="_blank" href="https://septianfauzi.com/assets/CV/CV_Septian_Fauzi_2023.pdf" rel="noreferrer">
                            <Button className="mx-1 text-white " variant="outline-secondary">Download CV</Button>
                        </a>
                    </Col>
