        ...
        <Fade>
            <Row style={{ minHeight: '100vh' }} id="home">
                <Col className="d-flex h-100 flex-column justify-content-center mt-xl-5 pt-xl-5 mt-xxl-5 pt-xxl-5 mt-lg-5 pt-5 mt-5 pt-lg-5 mt-md-5 mt-md-2 pt-md-5 mt-sm-5 pt-sm-5 align-items-start" xs={12} sm={12} md={12} lg={6} xl={6}>
                    ...
                    <p className="text-white">Greetings, I'm Septian Fauzi. I'm deeply curious about technology development, particularly when it comes to websites. I have over 3 years of experience in website development. Some of the technologies I frequently use include HTML, CSS, Javascript, Typescript, ReactJS, Jest, React Testing Library, Styled Component, Bootstrap, PHP, REST API Axios, Redux, Git, and many others. I am very happy if I can collaborate with everyone to develop and build projects that are useful for many people. If you're seeking a partner to help build a website, please don't hesitate to reach out to me to build your awasome project.</p>
